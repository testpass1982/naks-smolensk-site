    ...
    def send_email(self, message):   
            mail_selector = {
                'Заявка': {
                    ...
                    'message': 'Уважаемый {}, информируем вас, что ваше сообщение получено и передано в работу'
                },
                'Подписка': {
                ...
                'Вопрос': {
                    ...
                    'message': '{}, мы получили ваш вопрос, в ближайшее время вы получите ответ'
                }
            }
            if message.typeof in mail_selector.keys():
                try:
                    send_mail(
                        ...
                        mail_selector[message.typeof]['message'].format(message.sender_email),
